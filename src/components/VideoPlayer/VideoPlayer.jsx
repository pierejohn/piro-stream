...
export default function VideoPlayer({ movieDetails,setIsPlayingVideo }) {
    const { imdb_id, title, id } = movieDetails
...
<button className='text-red-900 mb-4 flex gap-2 items-center md:text-2xl lg:text-3xl text-xl cursor-pointer' onClick={()=>goBack()}><IoCaretBackOutline />Back
</button>
            {/* Title */}
...
>
  <iframe
    ...
    "
    src={`https://vaplayer.ru/embed/movie/${imdb_id}`}
    frameBorder="0"
    allowFullScreen
